...
Rectangle.prototype.createRectSide = function () {
  this.ctx.moveTo(
    this.diagonal1.startPoint.xCoordinate,
    this.diagonal1.startPoint.yCoordinate
  );
  this.ctx.lineTo(
    this.diagonal2.startPoint.xCoordinate,
    this.diagonal2.startPoint.yCoordinate
  );
  this.ctx.lineTo(
    this.diagonal1.endPoint.xCoordinate,
    this.diagonal1.endPoint.yCoordinate
  );
  this.ctx.lineTo(
    this.diagonal2.endPoint.xCoordinate,
    this.diagonal2.endPoint.yCoordinate
  );
  this.ctx.lineTo(
    this.diagonal1.startPoint.xCoordinate,
    this.diagonal1.startPoint.yCoordinate
